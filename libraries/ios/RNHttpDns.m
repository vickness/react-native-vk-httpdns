...
/** 导出SET方法*/
RCT_EXPORT_METHOD(getService:(NSString *)accountID secretKey:(NSString *)secretKey) {
    self.httpDnsService = [[HttpDnsService alloc] initWithAccountID:accountID.intValue secretKey:secretKey];
}
